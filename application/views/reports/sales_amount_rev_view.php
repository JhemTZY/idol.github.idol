            ...
            <ol class="breadcrumb" style="background-color:transparent ;">
                <li class="breadcrumb-item">
                    <h1 style="color: white;">
                        <i class="fa fa-dollar" aria-hidden="true"></i> NCFL Plan / Sales</small>
                    </h1>
                </li>
            </ol>
        </nav>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header ">
                        <h3 class="box-title">SALES AMOUNT (
                            <?= $selectedDPRNO; ?> )
                        </h3>
                        <button class="button-33"
                            onclick="exportTableToExcel('tbl_models', 'Sales_Amount_<?= $selectedDPRNO; ?>')"><i
                                class="fa fa-download" style="color : black;"></i> Export Data</button>
                        <div class="box-tools">
                            <form action="<?php echo base_url(); ?>index.php/task/sales_amount_rev_view" method="POST">
                                <div class="input-group">
                                    <select type="text" name="revi" class="form-control selecting"
                                        style="width: 180px;">
                                ...
                                if (!empty($revision)) {
                                    ...
                                    <div class="input-group-btn">
                                        <input class="fa fa-search btn btn-lg btn-success myModal" type="submit"
                    ...
                    ?>
                            ...
                            <tbody>
                                ...
                                foreach ($models_datas as $models_data) :
                                    ...
                                    <td class='h4'></td>
                                    <td class='h4'>
                                        <?= $customer_total[$models_data->customer]['sales_qty'][$models_data->month_year]  ?>
                                    </td>
                                    <td class='h4'>
                                        <?= $customer_total[$models_data->customer]['sales_amount'][$models_data->month_year]  ?>
                                    </td>
                                    <?php endforeach; ?>
                                </tr>
                            </tbody>
