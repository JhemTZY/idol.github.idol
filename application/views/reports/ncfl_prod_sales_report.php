        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="background-color:transparent ;">
               ...
               <li class="breadcrumb-item"><a href="<?= base_url() ?>index.php/Prod_Sales_Amount/Prod_Sales_report" class="btn btn-lg btn-outline-success" style="color:white"><i class="fa fa-file-o"></i> PLAN</a></li>
                <li class="breadcrumb-item"><a href="<?= base_url() ?>index.php/Prod_Sales_Amount/new_ncfl_actual_report" class="btn btn-lg btn-outline-success" style="color:white"><i class="fa fa-check-circle"></i> ACTUAL</a></li>                <li class="breadcrumb-item"><a class="btn btn-lg btn-outline-info" style="color:white; " data-toggle="modal" data-target="#generate_upload_file"> <i class="fa fa-download"></i> Download</a></li>
            </ol>
        </nav>
    </section>
                ...
                <div class="box box-success" style="padding:1rem;">
                    <div class="box-header" style="margin-bottom:5rem ;">
                        ...
                        <div class="text-center text-black">
                            ...
                            <hr style="width:23%">
                             <button class="btn-lg btn-primary" style="width:23%" onclick="exportTableToExcel('tbl_models', 'PROD_SALES_REPORT ?= $selectedDPRNO; ?>')"><i class="fa fa-download"></i> Download</button>
                            ...
                            <table class="table table-bordered" id="tbl_models" style="color:black;">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" colspan="7" v-for="month in Months"> {{ month?.working_days }} Days </th>
                                    </tr>
                                    <tr style="background-color:PaleGreen;">
                                        ...
                                        <th class="text-center" colspan="7" v-for="month in Months"> {{ month?.month_year }} </th>
                                    </tr>
                                    <tr style="background-color:PaleGreen;">
                                        <!-- <th colspan="3"></th> -->
                                        <template v-for="month in Months">
                                            ...
                                            <th class="text-center"> <b> SALES AMOUNT</b> </th>
                                             <th class="text-center"> <b> INVENTORY</b> </th>
                                            <th class="text-center"> <b> INVENTORY AMOUNT</b> </th>
                                        </template>
                                    </tr>
                                </thead>
                                <tbody>
                                    <template v-for="(modelsID,customer) in psiData">
                                        ...
                                        <template v-for="models in modelsID">
                                                ...
                                                <tr>
                                                    <template v-if="models.modelDT.isHidden !== '1' && models.modelDT.status !== 'Inactive'">
                                                    <td> <b> {{ models.modelDT.item_code}} </b></td>
                                                    <td style="background-color:white;"> <b> {{ models.modelDT.models_desc }} <a style="color: blue; font-size: 10px;">{{ models.modelDT.model_remarks }}</a>  </b>
                                                    ...
                                                    <template v-for="month in Months">
                                                        ...
                                                        <!-- PROD -->
                                                          ...
                                                          <!-- SALES -->
                                                        <td style="background-color:white;" class="text-right" v-if="models[month?.month_year]?.isSalesEdit=='1'??'0' "> {{ number_format(models[month?.month_year]?.sales_qty) }} </td>
                                                        <td style="background-color:white;" class="text-right" v-if="models[month?.month_year]?.isSalesEdit=='0'??'0' "> {{ number_format(models[month?.month_year]?.sales_qty) }} </td>
                                                        <!-- SALES -->
                                                        ...
                                                        <td style="background-color:white;" class="text-right">{{number_format(models[month?.month_year]?.auto_inventory)}} </td>
                                                         <td style="background-color:white;" class="text-right">{{number_format(models[month?.month_year]?.Inventory_Amount)}} </td>
                                                    </template>

                                                      <template v-if="models[month?.month_year]?.category==2??'0'">

                                                          <td style="background-color:Khaki;" class="text-right">{{models[month?.month_year]?.price}}</td>
                                                        <!-- PROD -->
                                                        ...
                                                        <td style="background-color:Khaki;" class="text-right">{{number_format(models[month?.month_year]?.prod_amount)}}</td>
                                                        <td style="background-color:Khaki;" class="text-right">{{number_format(models[month?.month_year]?.sales_amount)}} </td>
                                                        <td style="background-color:Khaki;" class="text-right">{{number_format(models[month?.month_year]?.inventory)}} </td>
                                                         <td style="background-color:Khaki;" class="text-right">{{number_format(models[month?.month_year]?.Inventory_Amount)}} </td>


                                                    </template>
                                                     <template v-if="models[month?.month_year]?.category==3??'0'">
                                                    
                                                       <td style="background-color:LightGreen;" class="text-right">{{models[month?.month_year]?.price}}</td>
                                                        <!-- PROD -->
                                                        ...
                                                        <td style="background-color:LightGreen;" class="text-right">{{number_format(models[month?.month_year]?.auto_inventory)}} </td>
                                                         <td style="background-color:LightGreen;" class="text-right">{{number_format(models[month?.month_year]?.Inventory_Amount)}} </td>
                                            ...
                                            <template v-if="models.modelDT.cat_code =='SMPL'">
                                                <tr>
                                                 <template v-if="models.modelDT.isHidden !== '1' && models.modelDT.status !== 'Inactive'">
                                                    <td> <b> {{ models.modelDT.item_code}} </b></td>
                                                    <td style="background-color:LightGreen;"> <b> {{ models.modelDT.models_desc }} </b> <a style="color: blue; font-size: 10px;">{{ models.modelDT.model_remarks }}</a> </td>
                                                     <template v-for="month in Months">
                                                           <template v-if="models[month?.month_year]?.category==1??'0'">
                                                        <td style="background-color:white;" class="text-right">{{models[month?.month_year]?.price}}</td>
                                                        <!-- PROD -->
                                            ...
                                            <template v-if="models.modelDT.cat_code =='EOL'">
                                                <tr>
                                                 <template v-if="models.modelDT.isHidden !== '1' && models.modelDT.status !== 'Inactive'">
                                                    ...
                                                    <td> <b> {{ models.modelDT.item_code}} </b></td>
                                                    <td style="background-color:Khaki;"> <b> {{ models.modelDT.models_desc }} </b> <a style="color: blue; font-size: 10px;">{{ models.modelDT.model_remarks }}</a> </td>
                                                     <template v-for="month in Months">
                                                           <template v-if="models[month?.month_year]?.category==1??'0'">
                                                        <td style="background-color:white;" class="text-right">{{models[month?.month_year]?.price}}</td>
                                                        <!-- PROD -->
                                            ...
                                            <template v-if="models.modelDT.cat_code =='TOTAL'">
                                                <tr>
                                                    ...
                                                    <template v-for="month in Months">
                                                        <td style="background-color:PaleTurquoise;" class="text-center" style="text-align: center;">---</td>
                                                        ...
                                                        <td style="background-color:PaleTurquoise;" class="text-right"> {{ number_format(models[month?.month_year]?.auto_inventory) }}</td>
                                                        <td style="background-color:PaleTurquoise;" class="text-right"> {{ number_format(models[month?.month_year]?.Inventory_Amount) }}</td>
                                                    </template>
                                                </tr>
                                            </template>
                                            <template v-if="models.modelDT.cat_code =='EOLTOTAL'">
                                                <tr>
                                                    ...
                                                    <template v-for="month in Months">
                                                        ...
                                                        <td style="background-color:Khaki;" class="text-center" style="text-align: center;">---</td>
                                                        <td style="background-color:Khaki;" class="text-center" style="text-align: center;">---</td>
                                                        <td style="background-color:Khaki;" class="text-center" style="text-align: center;">---</td>
                                                        <td style="background-color:Khaki;" class="text-center" style="text-align: center;">---</td>
                                                        <td style="background-color:Khaki;" class="text-center" style="text-align: center;">---</td>
                                            ...
                                            <template v-if="models.modelDT.cat_code =='GRANDTOTAL'">
                                                <tr>
                                                    ...
                                                    <template v-for="month in Months">
                                                        <td style="background-color:LightSkyBlue;" class="text-center" style="text-align: center;">---</td>
                                                        ...
                                                        <td style="background-color:LightSkyBlue;" class="text-right"> {{ number_format(models[month?.month_year]?.auto_inventory) }}</td>
                                                        <td style="background-color:LightSkyBlue;" class="text-right"> {{ number_format(models[month?.month_year]?.Inventory_Amount) }}</td>
                                                    </template>
                                                </tr>
                                            </template>
                                        </template>
                    ...
                    <div class="box box-success">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <hr>
                                <button type="submit" class="btn btn-lg btn-block btn-success" role="button" id="btn_generatePSIupload_template">Generate</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-body text-center mx-auto" hidden>
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tbl_PSIupload_Template">
                            <thead>
                                <tr>
                                    <td>ID</td>
                                    <td>Model</td>
                            ...
                            <tbody>
                                <?php
                                $models = $this->db->query("SELECT  * FROM cias.tbl_models INNER JOIN cias.tbl_customer ON tbl_models.customer_models_id= tbl_customer.customers_id ORDER BY tbl_customer.sorting_code,tbl_models.sorting_code")->result();
                                foreach ($models as $m) :
                                ?>
                                    <tr>
                                        <td><?= $m->models_id ?></td>
 ...
 <script>
        $(document).ready(() => {
            ...
            $("#btn_generatePSIupload_template").click(() => {
                var date = $("#txt_selected_month").val();
                exportTableToExcel("tbl_PSIupload_Template", "NCFL-Actual Data-" + date);
            });
        })
    </script>
