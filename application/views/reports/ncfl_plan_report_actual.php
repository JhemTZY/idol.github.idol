        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="background-color:transparent ;">
               ...
               <li class="breadcrumb-item"><a href="<?= base_url() ?>index.php/Prod_Sales_Amount/Prod_Sales_report" class="btn btn-lg btn-outline-success" style="color:white"><i class="fa fa-file-o"></i> PLAN</a></li>
                <li class="breadcrumb-item"><a href="<?= base_url() ?>index.php/Prod_Sales_Amount/ncfl_plan_report_actual" class="btn btn-lg btn-outline-success" style="color:white"><i class="fa fa-check-circle"></i> ACTUAL</a></li> 
    ...
    var app = new Vue({
        ...
        methods: {
            get_actual_data: function() {
                axios
                    .post("<?= base_url() ?>index.php/task/get_actual_data", {
