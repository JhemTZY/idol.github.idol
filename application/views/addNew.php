            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url() ?>index.php/addNewUser" method="post" >
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required " id="email" value="<?php echo set_value('email'); ?>" name="email" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="isAdmin" name="isAdmin">
                                            ...
                                            <option value="">NCFL SALE/PLAN</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
