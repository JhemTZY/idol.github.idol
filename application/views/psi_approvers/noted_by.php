                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card shadow px-3 py-3">
                                <form action="<?php echo base_url(); ?>index.php/Psi_approver/psi_noted_by_status" method="POST" onsubmit = "alert_success()">
                                        ...
                                        <tr>
                                            ...
                                            <template v-else>
                                              <template v-if="models[month?.month_year]?.category==1??'0'">
                                                ...
                                                <td style="background-color:white;" v-else> <input type="text" class="psiCell form-control" style="cursor:cell; text-align:center; font-size:1.2rem; width:90px;" :value="roundoff(models[month?.month_year]?.auto_inventory/1000??'NULL')" disabled> </td>
                                            </template>
                                        </template>
