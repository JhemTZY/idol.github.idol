...
">
        ...
        <small  style="
    color: #dede29;
">View or modify information</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-warning">
                    <div class="box-body box-profile ">
                             ...
                             <?php 
                $profile = $this->ncfldb->query("SELECT 
                c.fcJobLevelDesc,a.fpEmpPic as image
                from masterdata as a
                inner join refdivision as b on a.fnDivId=b.fnDivId
                inner join refjoblevel as c on a.fnJobId=c.fnJobId
                inner join refdepartment as d on a.fnDeptId=d.fnDeptId
                where fnEmpId = '$email' ")->result();
                ...
                ?>
                  ...
                  <img class="profile-user-img img-responsive img-circle "  src="data:image/jpeg;base64,<?=base64_encode($details->image)?>" alt="User profile picture">
                    ...
                    <?php endforeach; ?>
                        ...
                        <p class="text-muted text-center"><?php echo $details->fcJobLevelDesc; ?></p>

                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>ID NUMBER </b> <a class="pull-right"><?= $email ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <?php $this->load->helper('form'); ?>
                        <div class="<?= ($active == "details")? "active" : "" ?> tab-pane" id="details">
                          ...
                          <!--   <form action="<?php echo base_url() ?>index.php/profileUpdate" method="post" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly class="form-control" id="email" name="email" placeholder="<?php echo $email; ?>" value="<?php echo set_value('email', $email); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
