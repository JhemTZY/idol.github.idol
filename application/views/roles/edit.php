            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>index.php/roles/editRole" method="post" id="editRole" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <form method="POST" action='<?php echo base_url() ?>index.php/roles/storeAccessMatrix'>
